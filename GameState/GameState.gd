...
var resourceCaps:Dictionary = ResourceHelpers.create_some_resources({rocks = 50, water = 20, silver=3, favor = 10, relics = 1, moonstone = 3, moonlight = 10, love = 10000000000}) 
